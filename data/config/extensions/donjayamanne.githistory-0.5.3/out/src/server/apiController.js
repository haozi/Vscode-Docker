...
let ApiController = class ApiController {
    constructor(app, gitServiceFactory, serviceContainer, commandManager) {
        ...
        this.doActionRef = (request, response) => __awaiter(this, void 0, void 0, function* () {
            ...
            switch (actionName) {
                case 'removeTag':
                    yield this.commandManager.executeCommand('git.commit.removeTag', new types_3.BranchDetails(gitRoot, branch), refEntry.name);
                    break;
                case 'removeBranch':
                    yield this.commandManager.executeCommand('git.commit.removeBranch', new types_3.BranchDetails(gitRoot, branch), refEntry.name);
                    break;
                case 'removeRemote':
                    yield this.commandManager.executeCommand('git.commit.removeRemote', new types_3.BranchDetails(gitRoot, branch), refEntry.name);
                    break;
            }
        ...
        this.doAction = (request, response) => __awaiter(this, void 0, void 0, function* () {
            ...
            switch (actionName) {
                default:
                    ...
                    break;
                case 'new':
                    this.commandManager.executeCommand('git.commit.doNewRef', new types_3.CommitDetails(gitRoot, branch, logEntry));
                    break;
                case 'newtag':
                    this.commandManager.executeCommand('git.commit.createTag', new types_3.CommitDetails(gitRoot, branch, logEntry), value);
                    break;
                case 'newbranch':
                    this.commandManager.executeCommand('git.commit.createBranch', new types_3.CommitDetails(gitRoot, branch, logEntry), value);
                    break;
                case 'reset_hard':
