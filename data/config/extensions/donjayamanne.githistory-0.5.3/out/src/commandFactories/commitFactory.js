...
let CommitCommandFactory = class CommitCommandFactory {
    constructor(commitCommandHandler, cherryPickHandler, checkoutHandler, compareHandler, mergeHandler, rebaseHandler, revertHandler, viewChangeLogHandler) {
        this.commitCommandHandler = commitCommandHandler;
    ...
    createNewCommands(commit) {
        return __awaiter(this, void 0, void 0, function* () {
            const commands = [
                new createBranch_1.CreateBranchCommand(commit, this.commitCommandHandler),
                new createTag_1.CreateTagCommand(commit, this.commitCommandHandler)
            ];
            return (yield Promise.all(commands.map((cmd) => __awaiter(this, void 0, void 0, function* () {
                const result = cmd.preExecute();
                const available = typeof result === 'boolean' ? result : yield result;
...
CommitCommandFactory = __decorate([
    ...
    __param(0, inversify_1.inject(types_1.IGitCommitCommandHandler)),
