...
const gitRef_1 = require("./ref/gitRef");
...
function registerTypes(serviceManager) {
    ...
    serviceManager.addSingleton(types_1.IGitRefCommandHandler, gitRef_1.GitRefCommandHandler);
    ...
    [types_1.IGitFileHistoryCommandHandler, types_1.IGitHistoryCommandHandler,
