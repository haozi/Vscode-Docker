...
* Fix issue [#284](https://github.com/HookyQR/VSCodeBeautify/issues/284) correctly convert VSCode `html.format.extraLiners`
...
* Fix bug [#106](https://github.com/HookyQR/VSCodeBeautify/issues/106) Copy and paste issue when `formatOnPaste = true`
...
* Set exact dependency versions (Fix [#85](https://github.com/HookyQR/VSCodeBeautify/issues/85))
...
* Add shortcut example (PR [#63](https://github.com/HookyQR/VSCodeBeautify/issues/63)) Thanks @Tallyb
...
* Fix [Issue [#18](https://github.com/HookyQR/VSCodeBeautify/issues/18): Duplication](https://github.com/HookyQR/VSCodeBeautify/issues/18) - same cause as [#14](https://github.com/HookyQR/VSCodeBeautify/issues/14) (VS Code changed the way ranges are processed)
* Fix [Issue [#15](https://github.com/HookyQR/VSCodeBeautify/issues/15): Fail to correctly use workspace setting for file types](https://github.com/HookyQR/VSCodeBeautify/issues/14) - introduced in version 0.1.3 (oops)
* Fix [Issue [#14](https://github.com/HookyQR/VSCodeBeautify/issues/14): Full file beautify doubles text on version 1.1.0](https://github.com/HookyQR/VSCodeBeautify/issues/14)
* Add tests for supported formats and nested settings.
* Cosmetic changes to readme/icon
* Beautify with no .jsbeautifyrc file in path tree will use workspace settings for tabs/spaces indent. [Issue [#11](https://github.com/HookyQR/VSCodeBeautify/issues/11)](https://github.com/HookyQR/VSCodeBeautify/issues/11)<br>Will use the editor setting if the file being beautified is visible, or workspace/user setting if it is not visible. (Beautify of a non-visible file can be envoked when beautify on save is enabled.)
* Allow beautify on save to work with types in `beautify.*Files` settings. [Issue [#9](https://github.com/HookyQR/VSCodeBeautify/issues/9)](https://github.com/HookyQR/VSCodeBeautify/issues/9)
* Fix `beautify.*Files` settings requiring a `.` before the extension (both styles are now accepted).
* Add beautify on save option. [Issue [#5](https://github.com/HookyQR/VSCodeBeautify/issues/5): Add Beautify on Save](https://github.com/HookyQR/VSCodeBeautify/issues/5)
...
* Fix typo: [Issue [#7](https://github.com/HookyQR/VSCodeBeautify/issues/7)](https://github.com/HookyQR/VSCodeBeautify/pull/7)
...
* Added allowing sub elements in config. Fixes [Issue [#3](https://github.com/HookyQR/VSCodeBeautify/issues/3): Allow separation of settings for html, css and js options like sublime.](https://github.com/HookyQR/VSCodeBeautify/issues/3)
...
* Added comments remover before JSON parse. Fixes [Issue [#2](https://github.com/HookyQR/VSCodeBeautify/issues/2): .jsbeautifyrc file not being used](https://github.com/HookyQR/VSCodeBeautify/issues/2)
* Changed default (unknown) processing to ask you what you want to use.
* Fixed [Issue [#1](https://github.com/HookyQR/VSCodeBeautify/issues/1): No handler found for the command: 'HookyQR.beautify'](https://github.com/HookyQR/VSCodeBeautify/issues/1)
* _Tries_ to mark any elements in `json.schema` settings as JSON, and thus beautify as JS.
* Added schema for `.jsbeautifyrc` file. (Requires VS Code v0.10.5+ see [Issue [#1](https://github.com/HookyQR/VSCodeBeautify/issues/1)](https://github.com/HookyQR/VSCodeBeautify/issues/1))
